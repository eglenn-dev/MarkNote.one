...
export function GlobeIcon({ width = 20, height = 20 }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function SettingsIcon({ width = 20, height = 20 }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function TimerIcon({ width = 20, height = 20 }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
...
export function LogoutIcon({ width = 20, height = 20 }: IconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={width}
